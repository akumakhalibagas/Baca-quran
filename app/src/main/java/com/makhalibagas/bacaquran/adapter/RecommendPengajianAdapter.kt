 ...
 */
class RecommendPengajianAdapter (var pengajianList: List<Pengajian> = listOf()) : RecyclerView.Adapter<RecommendPengajianAdapter.ViewHolder>(){
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private val imgView = view.findViewById<RoundedImageView>(R.id.imgView);
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_rekomend_video, parent, false))
    }
